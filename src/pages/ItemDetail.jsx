...
export default function ItemDetail() {
    ...
    if (!item) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-porcelain text-ink">
    ...
    return (
        <div className="min-h-screen bg-porcelain text-ink font-body p-8">
